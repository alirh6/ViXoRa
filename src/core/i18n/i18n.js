...
const DICT = {
  fa: {
    ...
    'games.play': 'بازی', 'games.score': 'امتیاز', 'games.start': 'شروع', 'games.again': 'دوباره', 'games.change': 'تغییر', 'games.pick': '🎮 انتخاب بازی', 'games.pickHint': 'بازی موردعلاقه‌ات رو برای این کارت انتخاب کن', 'games.all': '🎮 همهٔ بازی‌ها', 'games.best': 'رکورد', 'games.playNow': '▶ بازی', 'games.change': 'تغییر', 'games.pick': '🎮 انتخاب بازی', 'games.pickHint': 'بازی موردعلاقه‌ات رو برای این کارت انتخاب کن', 'games.all': '🎮 همهٔ بازی‌ها', 'games.best': 'رکورد', 'games.playNow': '▶ بازی',
  ...
  en: {
    ...
    'games.play': 'Play', 'games.score': 'Score', 'games.start': 'Start', 'games.again': 'Again', 'games.change': 'Change', 'games.pick': '🎮 Pick a game', 'games.pickHint': 'Choose a game for this card', 'games.all': '🎮 All games', 'games.best': 'Best', 'games.playNow': '▶ Play',
  ...
  fr: {
    ...
    'games.play': 'Jouer', 'games.score': 'Score', 'games.start': 'Start', 'games.again': 'Encore', 'games.change': 'Modifier', 'games.pick': '🎮 Choisir un jeu', 'games.pickHint': 'Choisis un jeu pour cette carte', 'games.all': '🎮 Tous les jeux', 'games.best': 'Record', 'games.playNow': '▶ Jouer',
  ...
  ar: {
    ...
    'games.play': 'العب', 'games.score': 'نقاط', 'games.start': 'ابدأ', 'games.again': 'مجدداً', 'games.change': 'تغییر', 'games.pick': '🎮 اختر لعبة', 'games.pickHint': 'اختر لعبة لهذه البطاقة', 'games.all': '🎮 كل الألعاب', 'games.best': 'أفضل نتيجة', 'games.playNow': '▶ العب',
