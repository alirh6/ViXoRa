...
(async () => {
  ...
  // مدافع چپ: جارو بین ستون ۱ تا ۴ + شلیک رو به بالا
  for (let i = 0; i < 90; i++) {
    const k = i % 6 < 3 ? 'ArrowRight' : 'ArrowLeft';
  ...
  console.log('tank-defense2:', JSON.stringify(st));
  await page.screenshot({ path: '/home/user/.tooling/e2e/shots/final-tank3.png' });
